...
ml impi mkl intel hdf5
source activate ProtSeq2StrucAlpha

# Log in to WandB
echo "WandB"
wandb offline    # write it in the terminal to start wandb

export CUDA_VISIBLE_DEVICES=0,1,2,3
NCCL_DEBUG=INFO
export TIMELIMIT=12:00:00    # maximum is 48h but if we reduce the amount of hours it goes in front of other jobs 
echo $QOS
